...
Системата дава възможност за едновременното добавяне на продукти с малко усилия. За целта разполага със средство за импорт, с който създавате множество нови продукти наведнъж.  

Опцията **Импорт** ще откриете в **Номенклатури » Продукти и материали**, меню **Средства**.  

![](905-product-import1.png){ class=align-center w=15cm }

Инструментът позволява да бъдат направени множество настройки в основни реквизти, вендор кодове, фасети на мерки, баркодове, прикачени файлове, дименсии, ценови листи.  
