...
По-голямата част от настройките в **Dreem ERP** се създават в модули **Номенклатури** и **Администрация**. След тяхното конфигуриране може да се стартират процесите по обработка на документи и справки в системата.    

## **Администрация**  

Настройките в [**Администрация**](../guide/erp/001-ref/004-settings/000-index.md) се отнасят до цялостната работа на системата.  
Включват дефиниции за достъп, стойности по подразбиране, автоматични генерации, номератори и други.  
