...
За системата са необходими също някои [глобални счетоводни настройки](https://docs.unicontsoft.com/guide/erp/001-ref/002-accounting/003-acc-admin-settings.html), на чиято база прилага счетоводни документи и сметки по подразбиране и извършва различни проверки.  
