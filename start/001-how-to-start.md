...
По-голяма част от настройките в **Dreem ERP** се създават в **Номенклатури**. Едва след като те бъдат конфигурирани, може свободно да се работи с документите и справките в системата.    

Друга част от настройките се извършват в **Администрация**. Те се отнасят до цялостната работа на системата и включват достъпност, стойности по подразбиране, автоматични генерации, номератори и други.  
