...
> **Контекстно меню** съдържа както общи, така и променливи опции, адаптирайки се към различните списъци с функционалности.  
...
Този филтър ще откриете в някои номенклатури (напр. **Контрагенти**, **Продукти и материали**), във всички списъци с документи и в справките.  

> Това е инструмент за филтриране на данни по зададени критерии на търсене. Реализира се чрез форма *Филтър*.  
...
Спрямо заложените в основния филтър критерии системата ще обзаведе списъка с отговарящите на тях записи.  
...
Това е полезно при стартиране на ново търсене, защото гарантира, че настройвате филтъра "от нулата".   
...
Различни бързи филтри са достъпни също от панел *Списък данни* на справки, форма за редакция на документи, номенклатури и др.  
...
Свързаните с това настройки са достъпни в основно меню **Средства » Настройки**. В секция **Контроли** могат да бъдат настроени:  
