...
![](903-lists-configuration5.png){ class=align-center }
...
> Във филтър формата има бутон **[x]** *Изчистване текущ филтър* за автоматично почистване на всички полета.  
...
Нов шаблон се добавя с бутон **[+]**, като преди това сте попълнили желани те полета на филтъра. Записаните готови филтри се отварят в падащ списък с бутони за контрол - закачане, редакция, изтриване.   
...
> В тази си форма справките (или части от тях) могат да бъдат копирани във външен файл, където списъкът подлежи на редакция и преформатиране.  
> Може да експортирате пълното съдържание на справка и в CSV или XLS файлове. Функцията е достъпна от меню **Средства » Експорт на данни**.  
