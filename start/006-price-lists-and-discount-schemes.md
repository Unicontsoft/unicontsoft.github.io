...
За настройка на промоционална ценова листа на първо място се създава нова ЦЛ, която включва намалените артикули. На следващ етап промоционалните ЦЛ могат да бъдат настройвани към която и да било друга ценова листа.  

> Системата позволява добавяне на множество промоции.   

Нова промоция може да въведете от раздел **Списъци » Промоции** във формата за редакция на избраната ценова листа.  
От реда за нов запис вдясно добавяте отделен ред за всяка промоционална ЦЛ. В колона *Промоция* системата предлага за избор само предварително въведените ценови листи.  
Начална и крайна дата се посочват в съответната колона за всеки ред. Именно така задавате от/до кога е в сила всяка от промоциите.   
