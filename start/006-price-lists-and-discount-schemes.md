...
## **ЦЛ за корекция в цената**

Системата дава възможност избрани артикули да бъдат изведени като изключения с различни цени от основните по ЦЛ.  
В този случай е най-подходящо да се използват ценови листи от тип **Корекция**.  

> Корекциите се прилагат автоматично по предварително зададен график.  

За създаване на **Корекция** е необходимо да добавите нова ценова листа от този тип. В нея включвате единствено артикулите с корекция (разлика) в цената.  

![](906-price-lists-and-discount-schemes7.png){ class=align-center w=15cm }

**График за прилагане** се дефинира от раздел **Списъци** на текущата **ЦЛ Корекция**.  

От полето вдясно на отделен ред се добавя всяка ЦЛ, за която се отнася корекцията. Системата позволява настройка на една корекция едновременно към няколко основни ценови листи.   

В поле **На дата** може да изберете дата за прилагане на цените от текущата корекция. Датата може да бъде различна при всяка от ценовите листи.    
...
Всяка промоция може да бъде деактивирана и активирана повторно. Това е възможно във всеки един момент чрез отметка в колона *Активна*.  
