...
Ценовите листи представляват шаблони - списъци с продукти и цени. Те се прилагат в документите за покупка и продажба. По този начин цената за всеки от настроените продукти се обзавежда автоматично.  

Системата позволява създаването и поддържането на множество такива списъци. Това дава възможност за настройка на общи и на отделни персонализирани (по контрагенти) ценови листи.  
...
В системата за такава база могат да се използват вече настроена друга основна ценова листа, последни доставни цени или среднопретеглени цени.  
