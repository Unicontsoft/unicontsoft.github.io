...
## **Прилагане на ЦЛ по график**

Системата дава възможност избрани артикули да бъдат изведени като изключения с различни цени от основните по ЦЛ.  
За целта се използват ценови листи от тип **Корекция**. 

За настройката на ЦЛ от този тип е необходимо създаването на отделна нова ценова листа. В нея се включват единствено артикулите с корекция (разлика) в цената.  
...
За всяка ЦЛ се избира дата за прилагане на цените от текущата корекция. Датата може да бъде различна при всяка от ценовите листи.    
