...
От полето вдясно се добавя отделен ред за всяка ЦЛ, към която ще се прилагат различните цени. Системата позволява една корекция да бъде настроена едновременно за няколко основни ЦЛ.   

От поле **На дата** може да изберете датата за прилагане на изключенията. Тя може да бъде различна при всяка от ценовите листи.  
