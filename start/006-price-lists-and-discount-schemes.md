...
От полето вдясно на реда за нов запис се добавят една или няколко ценови листи, за които се отнася корекцията. За всяка от тях може да бъде настроена различна начална дата за прилагане на цените от текущата **ЦЛ Корекция**.  
