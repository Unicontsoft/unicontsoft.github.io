...
Менюто предлага основни действия, свързани с маркираните текстове и записи. 
...
Действията, които системата предлага, са свързани с текущо отворените списъци като отделни прозорци.  
...
Лентата се намира в горната част на контейнера, непосредствено под **Основно меню**. В нея са изнесени някои от инструментите на основното меню за въвеждане на функционалности на форми, списъци и документи.  

![](902-container9.png){ class=align-center w=15cm }

## **Лента с бутони по групи функции**

Лентата с бутони се намира в лявата част на контейнера.  Функционалностите на системата са обединени в групи функции, управляващи стопанската дейност на организацията: Номенклатури, Търговска система, Други справки, Счетоводство, Мениджмънт, Контролен панел, ТРЗ, Организация, Производство, Администрация.  
