...
На тази стъпка се въвеждат основните данни за организацията, включващи **Име**, **Идент. No**, **ДДС No**, **Адрес**, **Телефони** и **Факс**.  
...
При тази стъпка се добавят име и длъжност на МОЛ по подразбиране за организацията.  
