...
- **Банкова сметка** - от опционалното меню се избира банкова сметка, за която се отнасят плащанията;   
...
![](901-bank1.png){ class=align-center }
...
![](901-bank2.png){ class=align-center }
