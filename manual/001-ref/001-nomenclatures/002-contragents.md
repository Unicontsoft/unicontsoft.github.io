...
## Създаване на нов контрагент:  
 ...
 3) **Въвеждане ръчно**:  
 С данни трябва да се обзаведат всички задължителни полета, като изискуем минимум за създаване на нов контрагент. Това включва въвеждане на име, адрес, тип на контрагента и ДДС номер/Булстат.  
 Допълнително от реда за нов запис трябва да се добави списък с имена на лица и длъжности, данни за контакт и други.  
