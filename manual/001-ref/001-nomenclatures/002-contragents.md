...
## Създаване на нов контрагент:  
 ...
 3) **Въвеждане ръчно**:  
 Като минимум за създаване на нов контрагент, системата изисква попълване на няколко задължителни полета с валидни данни. Това включва въвеждане на име, адрес, тип на контрагента и ДДС номер/Булстат.  
 ...
 4) **Запис и изход** - напшравените промени се записват и формата за редакция се затваря.  
