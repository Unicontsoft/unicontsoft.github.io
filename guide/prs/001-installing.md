...
> На всяка от стъпките се бутон [**Напред**] се преминава към следващ етап на исталацията.  
Процесът може да бъде прекъснат с бутон [**Отказ**].  

![](901-installing5.png){ class=align-center }

За продължаване с инсталацията се поставя отметка за *Съгласен съм с условията на Лицензионното споразумение*.  

![](901-installing6.png){ class=align-center }

На тази стъпка има възможност за създаване на преки пътища до **Dreem Personal**.  
По подразбиране са избрани *Създаване на пряк път на работния плот* и *Създаване на пряк път в Quick Launch*.  

Чрез бутон [**Избор**] в поле *Папка за инсталация* се указва папката, в която ще се копират файловете на **Dreem Personal**.   
По подразбиране инсталацията предлага за папка за инсталация *C:\Program Files\Dreem Personal 2.0* на устройството, на което е инсталирана операционната система.  
...
**Dreem Personal** може да бъде стартиран от иконата на работния плот, в *Quick Launch* или от меню *Start » Programs » Dreem Personal 2.0*.
