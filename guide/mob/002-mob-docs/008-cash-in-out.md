...
В раздел **Основни** се попълват данни в следните полета:  
...
От раздел **Допълнителни** се въвежда сумата, за която се регистрира текущата операция. Това става от поле **Сума** на реда за нови записи, разположен в горната част на екрана.  
