...
Сторно операциите отразяват възстановяването на суми на по платени документи. Сумата се намалява от касовата наличност и се връща на клиент.  

> За всяка операция се издава сторно касов бон. 

Сторно може да бъде направено по:  
- Документ за продажба - Сторнира се единствено плащането по продажба, която е вече приключена и платена.  
- Кредитен документ - В този случай се създава кредитен документ за корекции по продажба и се сторнира плащането към нея.  
...
В раздел **Основни** се попълват данни за клиента.  
От раздел **Допълнителни** на реда за нов запис се избира кредитен документ, за който се възстановява сума.     
