...
Това отваря празна форма за въвеждане на данни. Тя се състои от два раздела: **Основни** и **Допълнителни**.   
...
От раздел **Допълнителни** се добавят документите, за които се регистрира текущото плащане. Това става от реда за нови записи, разположен в горната част на екрана.  
