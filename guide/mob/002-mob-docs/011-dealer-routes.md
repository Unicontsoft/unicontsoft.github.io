...
> При търсене на продажба с номер в редакция (пример: **E**0000000123) търсете с **.** (точка) в началото (пример: .123).  

![](911-dealer-routes2.png){ class=align-center w=7cm }

Работа в маршрута продължава с реализиране на доставките по продажби.  
