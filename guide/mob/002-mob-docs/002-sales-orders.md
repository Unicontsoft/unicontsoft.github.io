...
За въвеждане на заявка се избира бутон [**Нов**]. Това отваря нова форма с празни полета за въвеждане на данни за клиента.  
...
Над списъка се визуализират опционални бутони:  
   ...
   - **Редакция** - Отваря формата за редакция на предварително маркираната заявка и позволява промяна.  
   - **Обнови** - Служи за опресняване на списъка с документи за заявка.  
   - **Напред** - Продължава към следваща стъпка за създаване на заявка.   

   ![](902-sales-orders3.png){ class=align-center w=7cm }

Чрез бързия филтър или ръчно се намира и маркира желаният клиент. С бутона [**Напред**] системата отваря екран с всички заявки, продажби и задължения на контрагента.  
...
> Документите са разделени по тип в три отделни списъка (панела): **Заявки**, **Продажби** и **Задължения**.

![](902-sales-orders4.png){ class=align-center w=7cm }

Заявка се въвежда от списъка с документи на панел **Заявки** и бутон [**Нов**].  
Системата е попълнила всички полета, за които има данни в настройките на контрагента.  
