...
С това системата извежда форма с различни опции за приключване и генериране на свързани документи.  
...
Стойността в поле **Сума** е остатъкът за доплащане от клиента. Той се добавя автоматично към наличността в касата.  
