...
При създаване на продажба по подразбиране се визуализират само наличностите в текущия склад.  

![](902-lists13.png){ class=align-center w=5cm }

Чрез бутон **Налични** можем да визуализираме всички продукти, като за тези без наличност системата ще покаже индикация на реда.
Продуктите от тип услуга се визуализират винаги, нямат наличност и иконата им отпред в списъка е зелена.  
