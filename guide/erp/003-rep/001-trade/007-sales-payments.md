...
1) Раздел **Основни**:  
 ...
 Спрямо избрания вид групировка системата променя шаблона на справката. Добавя допълнителна информация за обект, дилър и детайли за просрочени вземания.  
...
3) Раздел **Контрагент** - в този раздел на филтър формата има възможност за избор на един или няколко клиента по обект, дилър и други;  
