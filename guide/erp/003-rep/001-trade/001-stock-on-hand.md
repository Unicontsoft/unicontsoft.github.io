...
Допълнително може да се изведе детайлна справка за избран продукт. Това става с десен клик вурху реда и избор на опция **Картон на продукт/ материал**.  

Чрез десен клик върху ред може да се отвори и форма с реквизити на продукта чрез опция **Редакция продукт [*]**.  