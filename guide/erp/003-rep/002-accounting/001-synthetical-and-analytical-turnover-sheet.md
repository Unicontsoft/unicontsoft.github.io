...
- **Със задбалансови сметки** - С активиране на тази опция справката показва данните по задбалансови сметки.  

- **Визуализация на салдо към началото на периода** - При поставена отметка в полето се визуализира колона **Салдо към началото на периода**.  
