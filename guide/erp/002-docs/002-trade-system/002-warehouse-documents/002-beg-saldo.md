...
1) От **Търговска система » Складови документи** чрез десен клик се избира **Нов документ**. Отваря се празна форма за въвеждане на нов складов документ.  
...
2)  В раздел **Основни** се попълват реквизити:  
    ...
    - **Обект** - в полето може да се посочи обект от предварително настроените в контрагент **Потребител на продукта**;  
...
За генерацията на **НСС**-*Начално салдо на склад* е необходимо дефиниране на следните критерии:  
   ...
   - **Стойност без количество в отделен документ** - Чрез опцията се указва генерация на допълнителен документ **НСС**. Той включва всички продукти без наличност в склада с остатъчна стойност.  
