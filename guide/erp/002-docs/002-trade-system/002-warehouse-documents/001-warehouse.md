...
Складов документ се създава от **Търговска система » Складови документи**. Това се прави чрез десен клик и **Нов документ**, с клавишна комбинация **Ctrl+N** или чрез бутон **Нов документ** в лентата с инструменти.  
Отваря се празна форма за въвеждане на данни.  

**2. Попълване на реквизити** 

От раздел **Основни** в поле **Док. тип** се избира тип на документа, което определя операцията като приход или разход за склада. Първоначално системата попълва реквизита с настройките по подразбиране.    
...
В секция *Собствени* чрез поле **Склад** се посочва складът, за който се отнася текущият документ.    
...
Секция *Титуляр* включва реквизити **Контрагент** и отнасящите се към него **МОЛ** и **Обект**.  
