...
- **Намерено кол.** - След преброяване в полето се нанасят фактически установените наличности.  
За улеснение системата е обзавела същите данни от колона **Количество**. Коригират се единствено полетата с разминавания.  
- **Липса** и **Излишък** - Тези полета се обзавеждат автоматично с установените разлики между **Количество** и **Намерено кол.**.   
