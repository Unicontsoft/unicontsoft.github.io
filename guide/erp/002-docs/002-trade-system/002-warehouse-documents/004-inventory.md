...
В документа има на разположение инструмент за бърза генерация на списък с продукти за преброяване. С валидирането на данните от проверката автоматично се генерират протоколи за липса и/или излишък. С това количествата в търговския склад се актуализират.  
