...
1) В **Търговска система » Протоколи за инвентаризация** се създава **Нов документ**. Това може да се направи чрез десен клик, чрез бутон **Нов документ** в лентата с инструменти или чрез клавишна комбинация **Ctrl + N**.  
