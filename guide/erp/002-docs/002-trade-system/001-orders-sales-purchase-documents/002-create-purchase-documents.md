...
- **Док. No** - В полето се въвежда номер на документа. Това може да бъде номер на В последствие системата може да копира този номер при генерацията на свързана фактура.   
