...
1) От **Търговска система » Документи за покупка** чрез десен клик върху списъка с документи се избира **Нов документ**. Отваря се празна форма за въвеждане на данни.  
...
Реквизити **Въвел** и **Обект** се обзавеждат автоматично според настройките на текущия потребител. Ако такива липсват или данните в полетата трябва да бъдат променени, се използват падащите списъци с предварителни настройки.   
...
- **Продукт/материал** — Отваря се форма за избор на продукт. Ако продуктите не са предварително въведени, системата позволява това да се направи в момента с десен клик и **Нов продукт**.  
