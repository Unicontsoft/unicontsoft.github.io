...
1) От **Търговска система » Документи за продажба** чрез десен клик върху списъка с документи се избира [**Нов документ**](003-create-sales-document.md#създаване-на-продажба). Отваря се празна форма за въвеждане на данни.  
