...
- [Въведение](#въведение)  
- [Как се въвежда аванс](#регистриране-на-аванс)  
...
> Моделът на работа е идентичен при аванси от клиенти и аванси към доставчици.  
...
> Системата предлага усвояване на аванс в документи, чиято стойност е различна от 0 (нула).
