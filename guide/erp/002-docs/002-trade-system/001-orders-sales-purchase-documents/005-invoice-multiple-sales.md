...
# **Фактура от множество продажби**

- [Въведение](#въведение)  
- [Генерация от форма с нов документ](#генерация-от-форма-нов-документ)
- [Генерация от списък Документи за продажба](#генерация-от-списък-с-продажби)  
...
## **Генерация от форма Нов документ**  
