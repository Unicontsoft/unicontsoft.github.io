...
Всички заявки се регистрират в системата по еднакъв начин. Различава ги тип на документа. Спрямо него в **Заявка към доставчик** се предлага генериране на свързана покупка, а в **Заявка от клиент** - генериране на свързана продажба.  
...
- **Док. Тип** - От падащия списък в полето се избира тип на документа - заявка от клиент, заявка към доставчик, вътрешна заявка или заявка за абонамент.  
