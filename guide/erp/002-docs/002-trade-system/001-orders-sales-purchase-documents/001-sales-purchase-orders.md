...
Заявките могат да се използват и за вътрешно фирмено искане за трансфер на стоки и материали. За целта е предвиден документ с тип **Вътрешна заявка**. Към нея автоматично се създава предавателен протокол за прехвърляне на стоки между складове.  
...
1) В раздел **Основни**:  
   ...
   - **Съставил** - полето за избор от падащо меню с предварително настроен списък служители;  
   ...
   - **Партида** - отваря форма за избор с налични партиди за избрания продукт;  
...
Този раздел не съдържа реквизити на настройка. В нрго системата осигурява пряк път до свързани документи. Ако заявката е валидирана и към нея има генерирани свързани документи, те се визуализират по тип в съответната папка.  
