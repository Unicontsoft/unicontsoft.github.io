...
1) В раздел **Основни**:  
   ...
   - **Предишно кол.** - ;  
   - **Валидирано кол.** - показва успешно валидирано количество за продукт на реда;  
   - **Отказано кол.** - в полето може да се попълни отказано количество за продукта на реда;  
   - **Свързано количество през склад** - ;  
   ...
   > Като отделни колони се визуализират и текущо настроените фасети и дименсии за Продукти и дълготрайни активи.  
