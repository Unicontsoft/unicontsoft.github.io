...
- **Печат** или **Преглед** - Чрез активиране на избраната опция документът се отпечатва или се отваря на екран за преглед (след избор на шаблон).  
...
- **Печат** или **Преглед** - С поставяне на отметка за документа се активира директен печат или преглед на екран (след избор на шаблон).  
