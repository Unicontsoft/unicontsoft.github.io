...
Поръчките към доставчик и от клиент се регистрират еднакво, но с различни типове заявки - **Заявки към доставчик** и **Заявки от клиент**. Системата дава възможност за генериране на необходимите свързани документи към тях за реализиране на сделката - покупки, продажби, складови, платежни документи и др.  

Заявките могат да се използват и за вътрешнофирмено искане за трансфер на стоки и материали. За целта е предвиден документ тип **Вътрешна заявка**. Към нея автоматично се създава предавателен протокол за прехвърляне на стоки между складове.  

## **Нов документ за заявка**

1) **Създаване**  

В системата тези документи се въвеждат от меню **Търговска система » Документи за заявка**. От списъка с документи чрез десен клик се избира **Нов документ**. Отваря се празна форма за въвеждане на данни.  

2) **Настройка**  

В раздел **Основни** на формата за редакция се попълват:  

- **Док. Тип** - От падащия списък в полето се избира тип документа.  
...
- **Търговец** - От списъка със служители в полето може да се избере отговорен търговец.  
...
Системата обзавежда **Мярка** с настроената за продукта мерна единица по подразбиране. В полето се отваря списък с всички възможни мерни единици според настройките на **Фасети на мерки**.  
