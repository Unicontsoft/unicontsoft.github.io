...
От раздел **Основни** на формата в поле **Док. Тип** се отваря падащ списък за избор на тип документ.  

> Спрямо типа на документа системата ще предложи различни опции за генериране при приключване на заявката.  
...
Останалите полета от секция *Собствени* се обзавеждат автоматично, когато в системата предварително са направени необходимите настройки. Това са реквизити **Търговец**, **Съставил** и **Обект**, в които се отварят падащи списъци за избор от персони и обекти.  
