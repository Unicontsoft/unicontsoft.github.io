...
- **Печат** и **Преглед** - С поставяне на отметка за документа се активира директен печат или преглед на екран (след избор на шаблон).  
...
1) В раздел **Основни**:  
   ...
   > Като отделни колони се визуализират и настроените дименсии, фасети и вендор кодове за продукти и дълготрайни активи.  
