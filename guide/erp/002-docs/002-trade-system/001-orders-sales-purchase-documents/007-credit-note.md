...
Системата поддържа лесно издаване и регистриране на кредитни документи при връщане на стока, намаление на цени и бонуси за натрупан оборот.  

> Методите за въвеждане на кредитни документи са аналогични при покупките и продажбите.  

Различните причини за създаване на документ за корекция се указват чрез тип на известието.  
За кредитните документи и известия от тип *Корекция на цени* и *Корекция на количества* се изисква връзка съответно с документ **Продажба** и **Фактура**. В системата има инструмент за тяхната генерация. Чрез него се създава задължителната връзка между вътрешнофирмени документи **Продажба** и **КДПрод**. Същото важи за връзката между данъчните документи **Фактура** и **КИПрод**.  
...
Чрез десен клик върху списъка с **Нов документ** се отваря празна форма за въвеждане на данни.  
...
В списъка се избира продажба, за която се праотнася корекцията. Могат да бъдат маркирани един или няколко документа.  
