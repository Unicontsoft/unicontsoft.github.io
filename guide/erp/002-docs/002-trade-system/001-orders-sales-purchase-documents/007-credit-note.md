...
1) В **Търговска система » Документи за продажба** чрез десен клик върху списъка с документи се избира **Нов документ**. Отваря се празна форма за въвеждане на данни.  
