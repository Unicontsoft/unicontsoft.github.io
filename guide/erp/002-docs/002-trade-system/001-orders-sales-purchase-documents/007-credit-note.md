...
В списъка с документи се маркира един или няколко документа за продажба, за които се прави корекция. Ако търсените документи не се визуализират в списъка, се променят параметрите в основния филтър и/или в *Бърз филтър*.     
С бутон **Напред** се преминава на следваща стъпка.  

![](907-credit-note1.png){ class=align-center w=15cm }

Системата извежда съдържанието на избраните продажби. От списъка се избират продуктите, за които се отнася корекцията.  
Генерацията се потвърждава с бутон **Избор**.  

![](907-credit-note2.png){ class=align-center w=15cm }

Отваря се форма с вътрешнофирмен документ **КДПрод**. Реквизитите в нея са автоматично попълнени. Системата позволява редактиране на данните в полетата.   
...
Системата автоматично обзавежда полето с текуща дата.  
...
Типовете са системно заложени:  
    ...
    - *Корекция на цени* се използва при промяна на цената за един или няколко продукта.  
    - *Корекция като бонус* [се създава](../../../005-how-to/002-correction-doc.md#кд-без-връзка-с-продажба) при специфични условия.   
...
При *Корекция на цени* отрицателни стойности приемат полетата в колона **Цена**.  
