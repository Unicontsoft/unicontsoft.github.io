...
За кредитните документи от тип *Корекция на цени* и *Корекция на количества* се изисква връзка с вече издадена продажба/ фактура. Системата разполага с инструмент за изграждане на такава. Чрез него се свързват вътрешнофирмените документи **Продажба** и **КДПрод**. Същото важи за връзката между данъчните документи **Фактура** и **КИПрод**.  
