...
# **Изписване с няколко склада**  

- [Въведение](#въведение)  
- [Регистриране на няколко доставки към една продажба или покупка](#регистриране-на-няколко-доставки-към-една-продажба--покупка)
...
- **Изписване от** (склад) / **Приход в** (склад) — В полето се поставя отметка и от падащото меню се избира склад.  
    ...
    **При покупка**: Системата автоматично създава тип **ПСД**-*приходен складов документ*.  
    ...
    - *Счетоводно записване* - С поставянето на отметка системата автоматично ще осчетоводи складовия документ. За да се обзаведе коректно счетоводната статия, [**Автоматичен счетоводител**](../../../001-ref/002-accounting/003-acc-wizard.md) трябва да е настроен предварително.  
