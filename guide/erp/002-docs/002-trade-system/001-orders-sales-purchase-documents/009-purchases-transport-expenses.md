...
4) **Преизчисляване на разходи** - Разходите за разпределение се изчисляват по продукти след избиране на метод за разпределение.  
...
- **Прилагане на промяна в отчетните цени** - Към последна стъпка в разпределението на разходи се преминава с бутон **OK**. Това отваря форма за потвърждаване на разпределението със следните опции:  
