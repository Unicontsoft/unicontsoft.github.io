...
- **Док. Тип** - се отваря падащ списък за избор на тип документ. По подразбиране системата попълва тип **Продажба**-*Документ за продажба*.  
- **Док. No** - съдържа номер на документа. Ако полето бъде оставено празно, при приключване на продажбата системата ще го обзаведе с пореден номер според настройките в **Номератори**.       
...
3) За валидиране на продажбата се избира бутон **Приключен** от лентата с инструменти. Това извежда форма **Свързани документи**, чрез която могат да се извършат останалите операции:  
