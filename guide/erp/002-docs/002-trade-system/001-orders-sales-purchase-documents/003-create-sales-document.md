...
- **Плащане в** (каса) — Чрез опцията се избира каса и се създава приходен касов ордер. Използва се, когато има плащане в брой, с карта или подобно (при определени [настройки](../../../005-how-to/018-card-payments.md)).  
