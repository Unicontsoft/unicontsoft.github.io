...
> За да се генерира коректен счетоводен запис, трябва предварително да има настройки на транзитна сметка в [**Сметкоплан**](../../../001-ref/002-accounting/002-chart-of-acc.md) и в [**Автоматичен счетоводител**](../../../001-ref/002-accounting/003-acc-wizard.md).  
