...
1) От **Търговска система » Касови документи** чрез десен клик върху списъка с документи се избира **Нов документ**. Отваря се празна форма за въвеждане на данни.   
...
2) В раздел **Основни** се попълват реквизити:  
 ...
 - **Каса** – Чрез този реквизит се указва текуща каса за прихващането. Може да се направи предварителна настройка с отделна каса за прихващания от [**Номенклатури » Референтни номенклатури**](../../../001-ref/001-nomenclatures/001-ref-nomenclatures.md).  
