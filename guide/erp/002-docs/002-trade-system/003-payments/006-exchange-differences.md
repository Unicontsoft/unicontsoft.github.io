...
2) От **Търговска система » Банкови документи** чрез десен клик върху списъка се избира **Нов документ**. Отваря се празна форма за въвеждане на данни.  
