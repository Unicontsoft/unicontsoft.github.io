...
- [Въведение](#въведение)  
- [Как се създава банков документ](#нов-банков-документ)  
- [Реквизити](#реквизити)  
...
Въвеждане на банков документ може да бъде направено ръчно или чрез [импорт](../../../005-how-to/001-bank-statement-import.md) на данните при наличен файл с извлечение от банката.  
...
С бутон [**Запис и изход**] в лентата с инструменти БИ се записва и формата се затваря.  
