...
Нов счетоводен документ се създава в меню **Счетоводство » Счетоводни документи**.  
...
В раздел **Документ** се въвежда основна информация за документа, свързана с дневниците по ЗДДС. Попълват се следните реквизити:   
   ...
   - **Основание за прилагане** - Отваря списък за избор от предварително настроените основания за прилагане. Полето трябва да се обзаведе според типа на текущия документ.  
   За типове документи, които не се включват в отчетните регистри, полето остава празно.  
   - **ДДС** - Реквизитът се попълва автоматично с процент ДДС, настроен за избраното **Основание за прилагане**.  
