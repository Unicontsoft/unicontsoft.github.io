...
1) От **ТРЗ » Разчетно–платежни ведомости** чрез десен клик върху списъка се избира **Нов документ**.  
...
6) Чрез бутон **Приключен** от лентата с инструменти **РПВ** се валидира и се отваря форма за генерация **Свързани документи**.  
    ...
    - **Печат** или **Преглед** - Отваря се форма за избор на шаблон. Могат да бъдат разпечатани **РПВ** и **Обща рекапитулация**.    
