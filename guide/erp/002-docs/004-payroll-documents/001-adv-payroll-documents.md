...
За автоматичното съставяне на тези документи е необходимо да бъде настроена номенклатура със служителите на организацията.  

## **Генериране на АРПВ**

1) От **ТРЗ » Авансови разчетно–платежни ведомости** чрез десен клик върху списъка се избира **Нов документ**.  
