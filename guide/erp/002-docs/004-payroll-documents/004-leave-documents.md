...
Използваните от служител на организацията дни отпуск (платен, неплатен или друг вид) трябва да се регистрират в системата. Това става чрез въвеждане на тип документ **Отп**-*Документи за отпуск*.   

## **Създаване на нов документ за отпуск**

1) От **ТРЗ » Документи за отпуск** чрез десен клик върху списъка се избира **Нов документ**.  
