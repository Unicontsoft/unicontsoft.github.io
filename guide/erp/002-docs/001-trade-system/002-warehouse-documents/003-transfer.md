...
За трансфера се създава **Пред**–*Предавателен протокол (между складове)* с предаващия склад. Към него се генерира свързан **Прием**–*Приемателен протокол (между складове)* с приемащия склад. Тази операция оказва влияние на складовите наличности едновременно в няколко склада.  
