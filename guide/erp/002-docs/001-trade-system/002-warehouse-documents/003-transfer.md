...
```{tip}
Прехвърляне на цялата наличност от склад:  
В нов складов документ попълнете предаващия склад. От лентата с основно меню изберете Средства » Генериране на редове на база складова наличност. Чрез тази опция протоколът се попълва автоматично с текущо наличните продукти в склада.   
```
