...
Всяко движение на материали, стоки и продукция от един склад/обект към друг трябва да бъде отразено в системата. Прехвърлянето между складове оказва влияние на складовите наличности едновременно в няколко склада.  
Операцията се регистрира с отделни складови документа за всеки от участващите складове:   
- Създава се **Пред**–*Предавателен протокол (между складове)* в предаващия склад. С него се намаляват наличностите на избрани продукти.   
- Генерира се свързан **Прием**–*Приемателен протокол (между складове)* в приемащия склад. Избраните продукти се добавят в наличността на насрещния склад.   
...
> Системата дава възможност за автоматично прехвърляне на цялата складова наличност от един в друг склад.  
В нов предавателен протокол се попълва предаващия склад. От меню **Средства** се избира опция **Генериране на редове на база складова наличност**. Това зарежда списък с всички налични продукти в текущи склад. Документът се приключва без особености.  
