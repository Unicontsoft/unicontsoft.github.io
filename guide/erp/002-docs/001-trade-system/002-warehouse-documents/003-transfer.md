...
```{tip}
При прехвърляне на цялата наличност от склад:  

В нов предавателен протокол посочете склад, от който се прехвърлят наличности.  
От лентата с основно меню изберете Средства » Генериране на редове на база складова наличност. Чрез тази опция протоколът се попълва автоматично с всички текущо налични продукти в склада.   
```
