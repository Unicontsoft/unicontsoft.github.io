...
- **Ctrl+Shift+M** (Изпращане на съобщение по ел. поща) - Изпраща текущи данни като прикачен файл. Използва се в документи и справки.  
...
- **Insert** или **Space** (Маркиране избрани) - Поставя/премахва маркирова върху избрани редове.  
...
- **F5** или **Ctrl+R** (Обновяване) - Опреснява информацията в текущата форма.  
- **Ctrl+M** (Преведи) - Отваря форма **Многоезичност** за добавяне на превод към избрана номенклатура.   
...
- **Ctrl+Shift+D** - В справки се използва зa визуализиране на данните в списък.  
В списъците с номенклатури и документи се използва за редактиране на дименсия.   
...
- **Ctrl+Y** (Приключен) - Променя състоянието на документа в *Приключен* (валидиран).  
- **Ctrl+Shift+Q** (Анулиран) - Променя състоянието на документа, като го отменя и унищожава.  
- **Ctrl+I** (Импорт) - Стартира помощник за импорт на данни (номенклатури или документи).  
...
- **Alt+V** (Вземания и задължения от контрагент)- Отваря бърза справка с вземания и задължения за избран контрагент.  
- **Alt+K** (Работна карта) - Създава нова работна карта към избрана покупка/продажба.  