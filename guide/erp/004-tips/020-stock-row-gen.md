...
Генерирането на редове с наличност може да бъде използвано в различни ситуации, например за трансфер между складове.  
...
Потвърдете с бутон [**OK**], за да обзаведете документа с продукти и наличности. Можете да редактирате списъка според нуждите на конкретната складова операция.  
