...
С бутон [**Enter**] действието се потвърждава. С това системата преизчислява новите стойности спрямо извършените промени.  

![](901-calc1.png){ class=align-center w=15cm }

Чрез калкулатора може да се въведе формула и да се размножи по редове нагоре/надолу. Това е ефективно средство за бързо преизчисляване на стойности в множество редове.  
