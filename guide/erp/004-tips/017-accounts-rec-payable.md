...
В системата може да бъде показана кратка справка с вземания и задължения на контрагент. Тя е достъпна от **Търговска система** за документи за продажба, покупка и заявка.  
