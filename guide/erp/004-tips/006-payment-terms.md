...
Настройката е достъпна от форма за редакция на **Контрагент** в раздел **Допълнителни » Реквизити: Продажби**. При нея системата ще предлага този начин на плащане, когато за избрания контрагент се създава нова продажба.  
