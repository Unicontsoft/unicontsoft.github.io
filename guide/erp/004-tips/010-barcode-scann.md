...
Баркодът се използват като критерий за търсене в полетата за въвеждане на продукт. Такива има в бързите филтри (поле **Име**), във филтър формите, в редове за добавяне на нов запис в документи, номенклатури (поле **Продукт/материал**) и други.   
...
Когато няма пълно съвпадение на баркод, системата извежда форма за избор от списък **Продукт/Материал**. Същото важи и за случаите, когато няма настроен баркод за даден продукт.  
