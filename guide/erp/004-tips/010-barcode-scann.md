...
Баркодът се използва като критерий за търсене в полетата за въвеждане на продукт. Такива има в бързите филтри (поле **Име**), във филтър формите, в редове за добавяне на нов запис в документи, номенклатури (поле **Продукт/материал**) и други.   
