...
Основанията за картови плащания създавате в **Номенклатури » Референтни номенклатури » Основания за плащане**. Те са пряко свързани с настройките за автоматично осчетоводяване на касови и банкови документи.  
   ...
   Може да създавате множество основания за плащане. Всяко от тях може да отговаря на картови плащания към избрана банкова сметка. Удобно е да отразите това в наименованието на основанието.  
   
   В последствие в **Автоматичен осчетоводител** ще обвържете основанията с избрани счетоводни подсметки. Може да включите и тази информация в наименованието.  
