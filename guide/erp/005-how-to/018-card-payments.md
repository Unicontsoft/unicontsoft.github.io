...
Тези документи за продажба се въвеждат стандартно, като вид на плащането е *С карта*.   

![](918-card-payments6.png){ class=align-center w=15cm }

Продажбата се приключва с генериране на касов документ в избрана безналична каса.  
В полето за основание на плащане се посочва настроеното за плащания с карта.  

> Основанията за плащане са водещи за коректното осчетоводяване на касов документ.   

![](918-card-payments7.png){ class=align-center }

> Задължително се издава данъчен документ, като се избира **Издаване Фактура за продажба / Отчет за продажби**.   

Останалите опции за свързани документи се маркират според ситуацията.  

2. **Касов документ**  

В приходния касов ордер има някои особености в следствие направените настройки за касата като безналична.  
...
В счетоводният запис към приходния касов ордер вземането от клиент се отразява като салдо по **с/ка 4141**.    

![](918-card-payments9.png){ class=align-center w=15cm }

3. **Банков документ**  

На следващ етап в системата се въвежда банково извлечение с постъпилите картови плащания.  
В документа се използва основание за плащане **Картови плащания**. Задължително се посочват свързани продажби.  
...
Банковият документ се приключва и осчетоводява. С това салдото по **с/ка 4141** се намалява.  
Счетоводна статия има следния вид:  
