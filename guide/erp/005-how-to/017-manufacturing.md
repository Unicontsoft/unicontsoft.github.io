...
```{Tip}
Когато дефинирате настройките на типове документи, трябва да вземете предвид желаната аналитичност на счетоводно отчитане.  
```
...
За всеки от тях може да бъде настроено автоматично осчетоводяване в отделна счетоводна сметка за различните складове.   
