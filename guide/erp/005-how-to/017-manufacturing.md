...
В **Търговска система || Складови документи** [създавате нов документ](../002-docs/002-trade-system/002-warehouse-documents/005-manufacturing.md#създаване-на-протокол-за-производство)  от тип **ППроизв_ПФ**. Във формата избирате полуфабрикатите, които ще се произвеждат.   
