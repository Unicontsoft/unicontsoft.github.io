...
Настройката на **Работни периоди** изисква задължително да има създаден разрешителен период. Допълнително се въвеждат работните периоди със забранителни настройки. Когато за даден период има едновременно разрешителни и забранителни настройки, системата прилага с приоритет забраните.  

Нов **Работен период** се създава с бутон *Нов* от лентата с инструменти или чрез десен бутон на мишката.  
