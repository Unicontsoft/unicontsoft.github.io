...
С функционалност [**Работни периоди**](../001-ref/004-settings/003-working-periods.md) системата предоставя именно такава възможност.    

> Настройката позволява документите от избрани периоди да останат видими, но недостъпни за определени действия.  

Настройката на **Работни периоди** изисква задължително да има създаден разрешителен период. Допълнително се въвеждат работните периоди със забранителни настройки. Когато за даден период има едновременно разрешителни и забранителни настройки, за системата с по-голяма тежест са забраните.  

**Работен период** се създава с бутон *Нов* от лентата с инструменти или чрез десен бутон на мишката.  
Във формата за редакция се попълват детайли за:
...
От реда за добавяне на нов запис дефинирате следните:  

- **Функционалност** - В тази колона може да посочите функционалност на системата, за която ще се отнасят настройките от реда. Ако настройките касаят всички функционалности, оставете полето празно. В противен случай всяка от тях се настройва с отделен ред.  
- **Тип док.** - Системата позволява да направите по-детайлни настройки по типове документи. Използвайте, когато настройките не се отнасят за цяла функционалност, а само за избрани типове документи от нея.  
...
- **Права** - От полето отваряте форма за редакция *Права на групи*. Има два изгледа на опциите, участващите в списъка - *Общи* и *Разширени*. Именно тук конфигурирате ограниченията.
...
На тази база може лесно да организирате настройките с един разрешителен и няколко забранителни периоди.  
Ще разгледаме примери, когато са удачни забранителни настройки: след годишно счетоводно приключване и след подадени месечни отчети по ЗДДС.   
...
Продължете с колона **Група**, като посочие първата група потребители, за която ще има ограничения. Конкретните права на групи трябва да настроите във формата за избор от колона **Права**.   
...
Групите, които не участват в работен период *Забрана 2025 г.*, ще продължат да имат настроените в разрешителния работен период права.
