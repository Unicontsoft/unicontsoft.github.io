...
- [При отделни документи за разходи за разпределяне и за покупка на стоки](#стоки-и-разходи-за-придобиване-в-отделни-документи)  
- [При разходи за разпределяне и покупка на стоки в общ документ](#стоки-и-разходи-за-придобиване-в-общ-документ)    
...
След като потвърдите избора, системата ще разпредели разхода на избраната за това база. Поле **Метод за разпределение** е обзаведено по подразбиране. От падащия списък имате възможност да изберете различен метод.    
