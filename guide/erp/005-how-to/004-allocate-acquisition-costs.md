...
Може да вземем за пример транспортни разходи с доставчик, различен от този на стоките.  

Покупката на стоките регистрирате в системата като въведете **Покупка**-*Документ за покупка* и **ПСД**-*Приходен складов документ*.  

Създавате отделен документ за покупка с разхода за транспортни услуги. Използвайте настроения за целта продукт *Транспорт (по придобиване)*. Стартирате разпределението от **Средства » Разпределение на разходи за придобиване**.  
...
От формата на документа за покупка избирате **Средства » Разпределение на разходи за придобиване** и следвате стъпките.
