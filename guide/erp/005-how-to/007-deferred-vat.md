...
- [Въведение и задължителни настройки](#въведение-и-задължителни-настройки)   
- [Покупка с отложен ДДС](#покупка-с-отложен-ддс)  
- [Въвеждане на фактура за покупка, получена със закъснение](#въвеждане-на-фактура-за-покупка-получена-със-закъснение)  
...
![](20240321-def-vat1.png){ class=align-center w=15cm }
...
![](20240321-def-vat2.png){ class=align-center w=15cm }
...
![](20240321-def-vat3.png){ class=align-center w=15cm }
...
![](20240321-def-vat5.png){ class=align-center w=15cm }
...
![](20240321-def-vat6.png){ class=align-center w=15cm }
...
![](20240321-def-vat7.png){ class=align-center w=15cm }
...
![](20240321-def-vat8.png){ class=align-center w=15cm }
