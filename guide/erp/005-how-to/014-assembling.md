...
От **Търговска система » Складови документи** създавате [**Нов документ**](../002-docs/002-trade-system/002-warehouse-documents/001-warehouse.md) (клавишна комбинация Ctrl+N). Във формата за въвеждане на складов документ обърнете внимание на следните реквизити в раздел **Основни**:  
...
**Генериране през рецепта** е опция в меню **Средства** от форма за редакция на документ.  
Тя активира помощник за генерация на свързания разходен складов документ **РПРК**. В него автоматично ще се обзаведат всички съставни части на комплекта.  
...
От избора на опция **Приключен** зависи дали при генерация на **РПРК** системата ще го генерира в състояние на редакция или с приключване.  
