...
**Дълготрайни активи** е отделна номенклатура със специфични си настройки. В голяма степен системата я третира аналогично на **Продукти и материали**. Затова те попадат в общ списък и еднакво могат да се използват в документите за покупка и продажба.  

При [въвеждането на ДА](../001-ref/001-nomenclatures/004-assets.md) системата изисква попълване на някои задължителни реквизити. Те са маркирани с червен символ - наименование, стойност и дата на придобиване, дата на въвеждане в експлоатация, счетоводна група и категория (по чл. 55 от ЗКПО).  

Базовите настройки за ДА трябва да се направят преди създаването на нов актив. Такива са: счетоводни групи, методи за амортизация, коефициент на преоценка и категории по чл.55 (ЗКПО) . Те могат да бъдат въведени и редактирани от [**Номенклатури » Референтни номенклатури**](../001-ref/001-nomenclatures/001-ref-nomenclatures.md).   

Пример:  
В системата трябва да се създаде нов актив *Лек автомобил*, който попада в *Категория V* с амортизационната норма 25% на година.  
Автомобилът е закупен на 23.04.2024 г. за 19940,38 евро. Въведен е в експлоатация на 01.05.2024 г.  

Тези данни попълвате във формата за редакция на ДА в раздел **Основни**.  
Преди да продължите с настройките е препоръчително да запишете въведените до момента данни.  
...
Докато първите две са възможни при определени обстоятелства, то амортизацията е неизбежна след пускане в експлоатация на актива. Затова следва да направите нужните настройки за амортизационни норми и амортизационен план.  

Чрез бутон [**Генериране**] в лентата с инструменти отваряте формата за избор на амортизационна норма (или период на експлоатация) и метод на амортизация.  
