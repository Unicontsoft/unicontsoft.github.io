...
След потвърждаване на импорта данните автоматично се попълват във формата.  
Продължавате с обработката на документа без особености.  
...
Отваряте избрания тип документ. В меню **Документ** посочвате опция **Експорт EDI файл**.   
