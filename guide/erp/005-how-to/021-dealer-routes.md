...
Списъкът с имената на служителите е предварително въведен в персоните на контрагент **Потребител на продукта**.  
- **Транспортно средство**  
Посочвате товарния автомобил, който изпълнява разноса на стоки.  
Транспортните средства се настройват в **Номенклатури » Референтни номенклатури**. При повече от един курс за деня може да се добавят като отделни транспортни средства.  
- **Дата на експедиция**  
