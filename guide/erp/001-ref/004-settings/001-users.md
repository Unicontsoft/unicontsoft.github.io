...
1) В раздел **Основни**:  
   ...
   - **Обект** - поле за избор на обект от предварително настроените за контрагент **Потребител на продукта**;  
 ...
 2) В раздел **Допълнителни**:  
    ...
    **Реквизити: Dreem Mobile**  
    ...
    Ако полето е празно, търговецът има достъп само до издадените от него документи.  
    - **Пул контрагенти** - указва групите контрагенти, до които потребителят има достъп;  
    Това са дименсиите, които служат за филтри при експорт на номенклатурата на контрагентите и обектите от Dreem за потребителя.  
...
3) В раздел **Списъци**:  
   - **Достъп до контрагенти** - Чрез полета *Контрагент* и *Обект* за текущия потребител се дава достъп до избрани контрагенти и техни обекти.  
