...
Настройката на номенклатура **Служители** е задължителна за обработката на документи в модул ТРЗ. Служителите трябва бъдат създадени предварително, след което да се обработват разчетно-платежни ведомости, сметки за изплатени суми, документи за отпуск и болнични.  
