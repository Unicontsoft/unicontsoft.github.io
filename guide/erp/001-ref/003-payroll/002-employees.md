...
Списъкът със служители трябва бъде въведен предварително. След това могат да бъдат обработвани разчетно-платежни ведомости, сметки за изплатени суми, документи за отпуск и болнични.  
...
2) Чрез десен клик върху избрана персона и **Редакция служител** се отваря форма за редакция **Служител**. Тук се въвеждат задължителните данни, необходими при обработка на документи в модул **ТРЗ**.   
