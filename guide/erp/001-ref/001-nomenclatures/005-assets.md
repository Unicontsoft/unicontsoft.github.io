...
1) В меню **Номенклатури » Дълготрайни активи** чрез десен клик и **Нов ДА** се отваря форма за въвеждане на нов актив. Задължителните реквизити са маркирани с червен символ.   
