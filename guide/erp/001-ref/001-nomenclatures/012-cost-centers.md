...
- [Въведение](#въведение)
- [Дефиниране на центрове на себестойност](#дефиниране-на-цс)   
- [Реквизити](#реквизити)
- [Свързани статии](#свързани-статии)  

## **Въведение**

С **Центрове на себестойност** се проследяват аналитично източниците на разходи и приходи. Чрез използването им се анализират фактическите спрямо планираните разходи и приходи.  
...
С десен клик върху реда се избира **Нов център**. Това добавя нов празен ред за попълване на данни.  
