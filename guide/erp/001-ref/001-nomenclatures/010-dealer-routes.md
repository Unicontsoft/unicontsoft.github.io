...
- [Въведение](#въведение)
- [Създаване на нов маршрут](#добавяне-на-маршрут)   
- [Реквизити](#реквизити)
...
В група функции **Номенклатури » Маршрути** с десен клик върху списъка със записи се избира **Нов маршрут**. Системата отваря празна форма за въвеждане на данни.  

![](909-dealer-routes1.png){ class=align-center w=15cm }

2. **Попълване на реквизити** 

Поле **Код** се попълва по желание. Задължително за попълване е полето **Име** с избрано наименование за маршрута.  
...
Въведените данни трябва да бъдат записани без излизане от формата. Това може да бъде постигнато чрез клавишна комбинация **Ctrl+S** или от меню **Номенклатура » Запис**.  

3. **Преглед и печат** 

Маршрутният лист се отваря за преглед и/или печат чрез съответния бутон от лентата с инструменти.  

Той показва справка за вземанията от клиенти, документи и обекти с адреси на доставка. Различен период на справката може да зададем от филтър формата. Тя се извежда най-лесно чрез клик с мишката в жълтото поле.

![](909-dealer-routes2.png){ class=align-center w=15cm }

4. **Запис**  

Чрез бутон [**Запис и изход**] в лентата с инструменти настройките се запаметяват и формата за редакция се затваря. С това маршрутът е добаявен в списъка.  
