...
- [Въведение](#въведение)  
- [Дефиниране на финансова структура](#финансова-структура-1)   
- [Реквизити](#реквизити)  
...
С десен клик върху реда се избира **Ново направление** или **Ново поднаправление**. Това добавя нов празен ред за попълване на данни.  
