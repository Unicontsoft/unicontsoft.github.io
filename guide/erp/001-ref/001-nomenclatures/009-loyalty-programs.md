...
- [Въведение](#въведение)  
- [Създаване на нова програма за лоялност](#добавяне-на-програма)  
- [Реквизити](#реквизити)  
...
В група функции **Номенклатури » Програми за лоялност** с десен клик върху списъка вдясно се избира **Нова програма за лоялност**. Отваря се празна форма за въвеждане на данни.  

2. **Попълване на реквизити** 

В раздел **Основни** се настройват реквизити **Код**, **Активен** **Име** и **Тип** на програмата за лоялност.  
...
В раздел **Допълнителни** се настройват период на валидност за програмата, срок за усвояване на натрупани точки и други реквизити.  
...
В раздел **Списъци** системата активира единствено реквизитите, които трябва да се настроят за избрания в раздел **Основни** *Тип* на програмата.  
...
Чрез бутон [**Запис и изход**] в лентата с инструменти настройките се запаметяват и формата за редакция се затваря. С това програмата е добаявена в списъка.  
