...
2) В раздел **Основни** се попълват задължителните полета с  **Име** и **Контрагент**, към които принадлежи обектът. Могат да бъдат добавени също данни за **Код**, **Адрес** и отговорен **Търговец** за обекта.  
