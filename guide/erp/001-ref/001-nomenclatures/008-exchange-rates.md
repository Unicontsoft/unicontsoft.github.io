...
- [Въведение](#въведение)  
- [Добавяне на нов валутен курс](#добавяне-на-валутен-курс)  
- [Реквизити](#реквизити)  
...
## **Добавяне на валутен курс**

1. **Създаване** 

За добавяне на нов запис се отваря група функции **Номенклатури » Валутни курсове**. Чрез десен клик върху списъка се избира **Нов валутен курс**. Отваря се празна форма за въвеждане на данни, в която се попълват няколко реквизита:  

![](907-exchange-rates1.png){ class=align-center w=15cm }

2. **Попълване на реквизити** 

В раздел **Основни** се избира **Дата**, за която се въвеждат валутните курсове. 
...
Чрез бутон [**Запис и изход**] в лентата с инструменти настройките се запаметяват и формата за редакция се затваря. С това валутният курс е добаявен в списъка.  
