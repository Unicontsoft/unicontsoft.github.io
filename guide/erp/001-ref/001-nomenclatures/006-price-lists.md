...
Чрез десен клик върху списъка вдясно се избира **Нова ценова листа**. Отваря се форма **Ценова листа** за въвеждане на данни.  
...
4) В раздел **Списъци** могат да бъдат настроени **Промоции**. Това са отделни ценови листи, които се прилагат с ограничена валидност.   
