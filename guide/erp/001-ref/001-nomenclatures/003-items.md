...
1) В меню **Номенклатури » Продукти и материали** с десен клик върху списъка с продукти се избира **Нов продукт**.  
...
2) Като минимум за създаване на нов продукт системата изисква попълване с валидни данни на полетата за име, тип и мерна единица.   
...
3) **Запис и изход** - Чрез бутона в лентата с инструменти  настройките се запаметяват и формата за редакция се затваря.  
