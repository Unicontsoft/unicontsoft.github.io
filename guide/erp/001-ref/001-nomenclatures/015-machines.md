...
- [Въведение](#въведение)
- [Създаване на нова машина](#добавяне-на-машина)   
- [Реквизити](#реквизити)
...
За създаване на нова машина се отваря група функции **Номенклатури » Машини**. С десен клик върху списъка със записи се избира **Нова машина**.  
...
В раздел **Основни** поле **Код** може да се попълни по желание. В противен случай системата прилага пореден свободен номер.  
...
В раздел **Допълнителни** системата дава възможност за добавяне на детайли за машината, като адрес на домуване, модел и сериен номер на двигателя, информация за гаранцията и историята на машината.  

3. **Запис**  

Чрез бутон [**Запис и изход**] в лентата с инструменти настройките се запаметяват и формата за редакция се затваря. С това машината е добаявена в списъка.  
...
1) В раздел **Основни**:  
   ...
   - **Инсталирал** - отваря списък за избор на служител, отговорен за инсталацията на машиата;  
   Персоните трябва да бъдат предварително настроени в **Потребител на продукта**.  
...
2) В раздел **Допълнителни**:  
   ...
   **Реквизити: Центрове на себестойност**  
   - **Структурен център на себестойност** - отваря форма за избор от настроените структурни центрове на себест-ст;  
   Използва се при генериране на продажби от договори през работни карти.  
   - **Обект/проект** - отваря форма за избор от настроените обекти;  
   Използва се при генериране на продажби от договори през работни карти.  
   - **Друг център на себестойност** - отваря форма за избор от настроените в раздел *Други* центрове на себ-ст;  
   Използва се при генериране на продажби от договори през работни карти.  
   - **ДМА** - отваря форма **Продукти и материали** за избор на свързан ДМА;   
