...
Празна форма за въвеждане на данни се отваря с десен клик върху списъка и **Нов обект**, с клавишна комбинация [**Ctrl + N**] или от бутона за **Нов** в лентата с инструменти.  
...
4) Всички направени промени се записват с бутон **Запис и изход** и формата за редакция се затваря.  
