...
- [Въведение](#въведение)   
- [Създаване на нов обект](#добавяне-на-обект)  
- [Реквизити](#реквизити)  

## **Въведение**  

Всяко подразделение на контрагент може да бъде въведено като негов обект. Това позволява дефиниране на индивидуални настройки и характеристики за всяко от тях - ценови листи, отстъпки, отговорен търговец и други.  
Системата използва тези параметри при генериране на документи и справки за контрагента.  
...
Обекти се добавят от меню **Номенклатури » Обекти на контрагенти**.  
Нова форма за въвеждане на данни се отваря чрез:  
- десен клик върху списъка и **Нов обект**;  
- клавишна комбинация **Ctrl + N**;  
- бутон за **Нов** от лентата с инструменти;    

![](902-sites-of-contragents1.png){ class=align-center w=15cm }
    
2. **Попълване на реквизити**

В раздел **Основни** се попълват задължителните полета с  **Име** и **Контрагент**, към който принадлежи обектът. Могат да бъдат добавени също данни за **Код**, **Адрес** и отговорен **Търговец** за обекта.  
...
В раздели **Допълнителни** и **Списъци** има множество настройки за обекта като ценова листа, схема с отстъпки, адрес на доставка, кост центрове, вендор кодове, списъци с издадени документи и други.    

3. **Запис**  

Чрез бутон [**Запис и изход**] в лентата с инструменти настройките се запаметяват и формата за редакция се затваря. С това обектът е добаявен в списъка.  
...
1) В раздел **Основни**:  
   ...
   - **ДДС/ Ид. No** – поле с ДДС или идентификационния номер (булстат) номер на контрагента;  
