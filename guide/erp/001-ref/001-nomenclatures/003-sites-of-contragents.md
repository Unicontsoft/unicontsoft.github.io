...
Празна форма за въвеждане на данни се отваря с десен клик върху списъка и **Нов обект**, с клавишна комбинация [**Ctrl + N**] или с бутон за **Нов** от лентата с инструменти.  

![](902-sites-of-contragents1.png){ class=align-center w=15cm }
    
2) В раздел **Основни** се попълват задължителните полета с  **Име** и **Контрагент**, към който принадлежи обектът. Могат да бъдат добавени също данни за **Код**, **Адрес** и отговорен **Търговец** за обекта.  
...
3) В раздели **Допълнителни** и **Списъци** има множество настройки за обекта като ценова листа, схема с отстъпки, адрес на доставка, кост центрове, вендор кодове, списъци с издадени документи и други.    

4) Всички направени промени се записват с бутон [**Запис и изход**]. С това формата за редакция се затваря.  
