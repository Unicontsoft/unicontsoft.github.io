...
9) **Стелажи** - Списък със складови локации се настройва чрез попълване на наименование в поле **Стелажи**.  
...
- **Стелажи** - попълва се наименование на текуща складова локация;  
