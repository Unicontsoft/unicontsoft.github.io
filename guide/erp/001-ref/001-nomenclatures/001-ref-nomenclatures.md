...
- **Потребител на продукта** - отваря форма **Контрагенти** за избор на потребител на продукта;   
...
- **Закръглявания на цени** - описателно наименование на настройката на реда;  
- **Посока** - указва посока на закръгляването за настройките на реда;  
- **Кратно** - ;  
- **Остатък** - указва сума на остатъка преди достигане стойността на поле **Кратно** от реда;  
