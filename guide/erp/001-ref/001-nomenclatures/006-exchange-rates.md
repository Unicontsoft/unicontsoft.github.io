...
Чрез поставяне или премахване на отметка за реквизит **Активен** номенклатурата активира или деактивира.  

**Банка** е задължително поле, в което се избира банката, настоена за потребителя като *Контрагент Търговска банка*.  
