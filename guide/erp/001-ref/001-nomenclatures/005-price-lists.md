...
Типът на ценовата листа определя начина, по който системата я третира.  
   ...
   - **Корекция** - Допълнителна ценова листа с разлики в цените спрямо основната ЦЛ, към която се отнася. Влиза в сила от предварително избрана дата.  
   - **Промоция** - Ценова листа с временна валидност на посочените цени. Настройва се за определен период с начална и крайна дата.  
