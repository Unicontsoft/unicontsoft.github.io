...
3) **Въвеждане ръчно** - Като минимум за създаване на нов контрагент се изискват валидни данни за име, адрес, тип на контрагента и ДДС номер/Булстат.  
...
4) **Запис и изход** - С бутон [**Запис и изход**] направените промени се повтърждават и формата за редакция се затваря.  
...
1) В раздел **Основни**:  
   ...
   - **Група** - отваря списък за избор на основна дименсия, към която принадлежи контрагентът;  
   ...
   - **Търговец** - чрез поставяне/махане на отметка персоната на реда се маркира като *Търговец*;  
...
2) В раздел **Допълнителни**:  
   ...
   **Реквизити: Основни**  
    ...
    Системата дава възможност за настройка на индивидуални схеми с ТО% по обекти.  
   ...
   **Реквизити: Продажби**  
    ...
    - **Задължителен обект** - в полето с *Да/Не* се потвърждава/отхвърля проверката за задължително избран обект на текущия контрагент при приключване на заявка/продажба;  
...
3) В раздел **Списъци**:  
    ...
    - **Търговци и обекти** - списък със служителите на *Потребител на продукта*, които могат да бъдат настроени като търговци към конкретен обект на текущия контрагент;  
...
В секции **Търговска система**, **Счетоводна система** и **Организация** са достъпни всички документи, генерирани в системата, с избрания контрагент.  
