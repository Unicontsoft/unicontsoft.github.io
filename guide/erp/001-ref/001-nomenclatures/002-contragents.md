...
3) В раздел **Списъци**:  
    ...
    - **Търговци и обекти** - списък със служителите на *Потребител на продукта*, които могат да бъдат настроени като дилъри към конкретен обект на текущия контрагент;  
