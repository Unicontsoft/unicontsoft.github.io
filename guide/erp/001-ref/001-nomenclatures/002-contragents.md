...
1) От **Номенклатури » Контрагенти** с десен бутон на мишката върху списъка, се избира **Нов контрагент**. Отваря се празна форма **Контрагент** за въвеждане на данни.  
...
1) В раздел **Основни**:  
   ...
   Името на реквизита варира според наименованието на дефинираната **Дименсия за групи** в меню **Администрация » Настройки** .  
