...
При приключване на сторниращия документ сумите по видове плащания се попълват, както са били въведени в сторнирания ФБ.  

- *Сторно връщане/рекламация (с възстановяване на платената от клиента сума)* - Използва се при връщане на един или няколко продукта от клиент. За този тип сторниращ документ **Dreem POS** позволява също връщане/рекламация на цяла продажба.  
Сумата за възстановяване на клиента се попълва в поле **в брой**.  
