...
В списъка се визуализира колона за група. Полетата в нея се обзавеждат за всеки продукт с дименсията, в която участва. Чрез опцията **Групиране** списъкът може да бъде групиран по настроените дименсии.    
