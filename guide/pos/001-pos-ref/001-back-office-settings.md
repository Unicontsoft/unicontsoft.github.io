...
За коректно отчитане на продажбите и издаване на фактури, трябва да бъдат въведени отделните обекти за **Потребител на продукта**. [Списък с поделения (обекти)](../../erp/001-ref/001-nomenclatures/002-contragents.md) се настройва в раздел **Списъци** от форма за редакция на контрагента.  
...
Отделните обекти могат да работят с обща или с различни ценови листи. Всички ценови листи за крайни клиенти се настройват като *Ритейл*. При тях цена с ДДС се закръглява до втори знак.   

В бекофис системата има възможност за настройка и на промоционални ценови листи. За всяка от тях се настройва определен период на валидност и приоритет за определяне на водеща листа при съвпадение на артикули в няколко листи.  
