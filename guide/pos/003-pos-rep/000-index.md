...
> С потвърждаване на **Z отчет** системата може автоматично да генерира касов документ за прехвърляне на средствата. Необходима е настройка в [**Администрация » Настройки » Основание за плащане за дневен отчет**](../001-pos-ref/001-back-office-settings.md#администрация).     
...
Информацията е достъпна отново в списък с продукти. Маркират се един или няколко продукта (клавиш [**Ctrl**] + ляв клик). Чрез бутон [**Наличност**] или с клавиш [**F7**] се извежда форма с наличности по партиди за всички обекти/складове.  
