...
> При генерация на **Z отчет** системата може да генерира касов документ за прехвърляне на средствата. Необходима е настройка в [**Администрация » Настройки » Основание за плащане за дневен отчет**](../001-pos-ref/001-back-office-settings.md#администрация).     
