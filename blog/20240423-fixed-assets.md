...
Като подобрения на ДА се признават разходи, които осигуряват икономическа изгода, надминаваща очакваната стандартна ефективност на актива. Тези разходи увеличават отчетната стойност на актива.  
При подобрения данъчната амортизируема стойност се увеличава от началото на месеца, през който са завършени разходите.  

В системата *Стойност* и *Дата на подобрението* се настройват през картон на ДА в панел *Списъци || Подобрения*.  
