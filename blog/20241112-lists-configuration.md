...
Характерното за нередактируемите списъци, както подсеща името им, е, че записите в тях са недостъпни за корекции.  
...
<ins>За да работят максимално бързо списъците с документи, по възможност избягвайте филтриране за твърде дълъг времеви период.</ins>
