...
Ще разделим списъците условно на два типа, за да разгледаме особеностите при работа с всеки от тях: 
...
Общото при работа и с двата вида е използването на филтри.  
...
В статията [Работа с колони на списъци](https://www.unicontsoft.com/cms/node/254) подробно са разгледани всички възможности, които системата дава при работа с колони.  
