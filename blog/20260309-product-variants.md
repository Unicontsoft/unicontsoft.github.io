...
За всеки продукт-вариант се дефинира различна разновидност.  
За целта в раздел **Допълнителни » Дименсии: Каталог** се определя дименсията, отнасяща се до възможните варианти. В поле *Стойност* трябва да бъде избран един от възможните варианти.    
