...
За правилното и ефективно функциониране на системата е необходимо изграждане на ключови настройки. Това включва създаване на номенклатури, дефиниране на параметри за генериране на документи, потребителски профили, счетоводни и други елементи от системната конфигурация.  
