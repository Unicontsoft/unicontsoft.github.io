...
Промяна на парола за текущия потребител може да бъде направена **Администрация » Смяна на парола**.  
...
1) **Настройки** - Системата отваря форма за настройки **Потребителска парола**.  
    ...
    - **Пак нова парола** - В полето трябва да се повтори избраната парола.  
