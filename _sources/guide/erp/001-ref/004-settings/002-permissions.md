...
- [Въведение](#въведение)  
- [Настройка на ефективни права](#настройка-на-ефективни-права)  
...
За да влязат в сила правата, трябва да се посочи при какви условия системата ще прилага ограниченията.  
Тази настройка е достъпна от **Администрация » Настройки » Системни: Ниво за сигурност**. Възможните варианти са:  
...
## **Настройка на ефективни права**

Реквизитите с настройки в **Администрация » Права на групи** са организирани в дървовидна структура. Те са отделени в секции с обекти на системата за сигурност и списъци с права за всеки от тях.  

1. Раздел **Функции**  

Разделът съдържа всички функционалности и модули на системата. Чрез него се управляват общите операции и достъпът до отделните функционалности.  
...
Тук могат да се дефинират специфични настройки за избрани детайли.  
