...
За системата са необходими глобални счетоводни настройки, на чиято база се прилагат счетоводни сметки и документи по подразбиране, извършват се различни проверки и генерации. 
