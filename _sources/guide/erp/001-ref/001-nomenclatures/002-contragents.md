...
3) В раздел **Списъци**:  
    ...
    Секция **Вендор кодове**  
    - **Продукти** - указва кодове за идентификация на продукти в информационните системи на текущия контрагент;  
    - **Контрагенти** - списък с кодове за идентификация на контрагенти в информационната система на текущия контрагент;  
    - **Обекти** - указва кодове за идентификация на обекти в системата на текущия контрагент;  
