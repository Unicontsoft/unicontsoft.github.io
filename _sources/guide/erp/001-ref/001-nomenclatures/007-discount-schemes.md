...
- [Въведение](#въведение)  
- [Създаване на схема с ТО%](#добавяне-на-схема-с-то)  
- [Реквизити](#реквизити)  
- [Свързани статии](#свързани-статии)  

## **Въведение**

Схемата с търговски отстъпки представлява шаблон с настроени намаления от цената, който може да се прилага в документи за заявки, покупка и продажба. Отстъпките се настройват в проценти. Настройката може да включва отстъпкли за една/няколко категория продукти, както и за избрани отделни продукти.  

Системата позволява създаване на множество схеми с ТО. Те могат да бъдат прилагани ръчно или да бъдат обвързани с настройките на избрани контрагенти.  

## **Добавяне на схема с ТО%**

1. **Създаване** 

За създаване на нова схема с отстъпки се отваря група функции **Номенклатури » Търговски отстъпки**. Чрез десен клик върху списъка вдясно се избира **Нова схема търговски отстъпки**. Отваря се форма за въвеждане на данни **Ценова листа**, в която се попълват няколко реквизита:  

![](906-discount-schemes1.png){ class=align-center w=15cm }

2. **Попълване на реквизити** 

В раздел **Основни** се настройват реквизити **Код**, **Активен** и **Име**.  
...
В раздел **Допълнителни** може да се дефинират **Категории**, които се използват при настройки за сигурност и ограничаване на достъпа до ценови листи.  
...
От раздел **Списъци** се настройват процентите с търговски отстъпки по групи и/или по продукти.  
...
Чрез бутон [**Запис и изход**] в лентата с инструменти настройките се запаметяват и формата за редакция се затваря. С това схемата е добаявена в списъка.  
...
[Ценови листи и схеми с ТО%](../../../../start/006-price-lists-and-discount-schemes.md)  
