...
Настройка се добавя чрез реда за нов запис, стоящ в началото на всеки списък.   
...
3) **Национална класификация на професиите и длъжностите** – В отделни записи се въвеждат всички длъжности и професии, за които има назначени служители. Това включва и самоосигуряващи се лица.  

4) **Категории труд** - За улеснение номенклатурата е системно въведена.  
Основно изискване е да има настроена категория по подразбиране. Това често е категорията труд, отнасяща се до по–голямата част от служителите.  
...
6) **Процент прослужено време** – Настройката указва процентите, с които РЗ се увеличава според годините трудов стаж на служителя.  
...
7) **Минимален осигурителен праг** - Настройката изисква за всяка година да се попълва минимален и максимален осигурителен праг. Това се отнася за всяка една от длъжностите в организацията.  
...
9) **Удръжки/Надбавки** - Настройката позволява въвеждане на списък с различни удръжки и/или надбавки, които да се отнесат по колони от **Декларация 1**.  
...
10) **Типове РПВ** - За добавяне на нова номенклатура системата изисква попълване на поле **Код** и наименование в поле **Типове РПВ**.  
...
12) **Празници и почивни дни** - Настройката е системно въведена. Включва всички дни за годината, официално приети за неработни.  
...
17) **Процент на осигуровки** – Настройката включва списък с данни за проценти от заплатата, които се начисляват за осигуровки.    
...
- **Национална класификация на икономическите дейности** - въвежда се наименование на икономическа дейност;  
- **От дата** - поле с календар за избор на начална дата;  
- **Процент трудова злополука** - указва % трудова злополука за икономическата дейност на реда;  
- **Пореден номер на квалификационна група професии на осигурения (кл 12.1 от Д1)** - указва код по НКПД за избраната професия/длъжност на реда;  
...
- **Пореден номер на основната икономическа дейност на осигурителя (кл 12.3 от Д1)** - указва номер на икономическа дейност по КИД;  
...
- **Тип** - отваря списък за избор на вид на настройката;  
...
- **% просл. време** - указва дали удръжката/надбавката се включва при изчисляване на % прослужено време;  
- **Колона от Декл. 1** - отваря падащ списък за избор с номера на колоните в **Декларация 1**;  
- **Следи се в картона на служителя** - указва дали удръжката/надбавката се следи в картона на служителя;  
