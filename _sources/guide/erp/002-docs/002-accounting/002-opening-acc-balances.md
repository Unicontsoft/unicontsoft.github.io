...
- [Въведение](#въведение)  
- [Как се генерират начални салда на счетоводни сметки](#генерация-на-начални-салда)  
- [Реквизити](#реквизити)  
...
Помощникът е достъпен от **Счетоводство » Начални салда на сметки**.  

## **Генерация на начални салда**

Генерацията може да бъде стартирана от меню **Средства** или чрез десен клик върху списъка през опция **Други средства**.    
 
![](902-opening-acc-balances1.png){ class=align-center w=15cm }

Системата извежда информация с предстоящите стъпки за създаването на НС.  
Към генерация се преминава с бутон [**Напред**].  

![](902-opening-acc-balances2.png){ class=align-center }

На тази стъпка се попълват година и сметки, за които се генерират НС.  
В поле **Сметка** се отваря списък с всички главни сметки от настроения [**Сметкоплан**](../../001-ref/002-accounting/002-chart-of-acc.md). Възможните варианти за избор са:  
...
![](902-opening-acc-balances3.png){ class=align-center }
...
![](902-opening-acc-balances4.png){ class=align-center }
...
![](902-opening-acc-balances5.png){ class=align-center w=15cm }
...
![](902-opening-acc-balances6.png){ class=align-center w=15cm }
...
1) В раздел **Документ**:  
   ...
   - **Док. дата** - показва дата на избрания свързан документ;  
   - **Док. No.** - показва номер на избрания свързан документ;  
