...
**Цена** и **Цена с ДДС** ще се попълнят автоматично, когато за избрания контрагент е дефинирана индивидуална ценова листа.  
...
> Резервирането на количества може да бъде отменено в последствие от **Търговска  система » Запазени количества**. Редът с документа, по който са запазени, се изтрива или количеството на продукта се редактира.  
