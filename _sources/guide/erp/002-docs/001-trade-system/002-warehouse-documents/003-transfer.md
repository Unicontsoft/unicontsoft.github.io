...
> Системата разполага с инструмент за автоматично зареждане на списък с налични продукти (вкл. партиди) за избран склад. 
Той е достъпен от меню [**Средства » Генериране на редове на база складова наличност**](../../../004-tips/020-stock-row-gen.md). Може да послужи при прехвърляне на цялата складова наличност от един склад към друг.   
