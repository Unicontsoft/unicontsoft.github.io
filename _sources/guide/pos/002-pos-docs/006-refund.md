...
Операциите по връщане/замяна на стока, отказ за получаване от клиента, операторска грешка и др. трябва да бъдат отразени в системата. С това наличностите на стоки в склада на обекта се актуализират. Сторниращите документи се отразяват в оборотите за деня и повлияват наличността на текущата каса.   
...
При приключване на сторниращия документ сумите по видове плащания се попълват, както са били въведени в сторнирания ФБ. Отпечатва се сторно фискален бон за цялата сума **В брой**. Чрез автоматично служебно въвеждане и извеждане на сумите, които не са в брой, системата се грижи за коректността на касовата наличност.  

- *Сторно връщане/рекламация (с възстановяване на платената от клиента сума)* - Използва се при връщане на един или няколко продукта от клиент. За този тип сторниращ документ **Dreem POS** позволява връщане/рекламация също на цяла продажба.  
Сумата за връщане на клиента се попълва в съответните полета по видове плащане. Отпечатва се сторно фискален бон за сумата **В брой**.  
...
Желаният документ се маркира и изборът се потвърждава с бутон [**Избор**] или с двоен клик.  
