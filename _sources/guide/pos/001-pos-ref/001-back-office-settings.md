...
Въвеждането на отделни обекти за **Потребител на продукта** служи за коректното отчитане на продажби и издаване на фактури. [Списък с обекти](../../erp/001-ref/001-nomenclatures/002-contragents.md) се настройва в раздел **Списъци** от форма за редакция на контрагента.  

Всеки обект може да се настрои с отделен [**Номератор**](../../erp/001-ref/004-settings/004-counters.md) за вътрешнофирмени и за данъчни документи.  
...
Складовете се създават предварително в [**Номенклатури » Контрагенти**](../../erp/001-ref/001-nomenclatures/002-contragents.md). В последствие всеки обект се обвързва със собствен склад. Настройката е достъпна от форма за редакция на **Потребител на продукта** в раздел **Списъци » Обекти**.  

## **Ценови листи**

Отделните обекти могат да работят с обща или с различни ценови листи (ЦЛ) за клиенти на дребно.  
Ценовите листи се дефинират от [**Номенклатури » Ценови листи**](../../erp/001-ref/001-nomenclatures/006-price-lists.md).    
...
Номенклатурата със стоки се създава и редактира от [**Номенклатури » Продукти и материали**](../../erp/001-ref/001-nomenclatures/004-items.md).  

> Продуктите не могат да бъдат модифицирани от фронтофис системата **Dreem POS**.  
...
1) Нов потребител се създава от [**Администрация » Потребители и групи**](../../erp/001-ref/004-settings/001-users.md). От менюто избираме опция Потребители. Чрез десен клик върху списъка се избира **Нов потребител**. Отваря се форма **Потребител** за въвеждане на данни.  

2) В раздел **Основни** е желателно да се попълнят всички реквизити. Когато всеки потребител се обвърже с обект, каса и склад, системата автоматично прилага тези реквизити при създаване на документ.  
...
Реквизитите *По подразбиране* се попълват чрез избор от предварително настроени списъци с номенклатури:  
    ...
    - **Обект** - Реквизитът се обзавежда, като се избира обект от настроените за **Потребител на продукта**.  
...
При генерация на дневен отчет на ФУ с нулиране (**Z отчет**) системата може да генерира в редакция **РКО** за прехвърляне на сумата. Това позволява автоматично прехвърляне на средствата от Z касата към друга избрана каса (напр. Централна каса).  
За целта е необходимо от меню **Администрация » Настройки** да бъде указано **Основание за плащане за дневен отчет**.  

> Ако настройката за основание при дневен отчет липсва, системата не генерира касов документ за прехвърляне на средства.  

![](901-back-office-settings5.png){ class=align-center w=15cm }