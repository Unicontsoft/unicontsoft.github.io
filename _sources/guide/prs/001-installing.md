...
- Потребител с административни права, който да конфигурира системни компоненти на Windows     
- 100MB свободно място за копиране на изпълнимите файловете     
...
Към изтегляне се преминава с бутон [**СЪГЛАСЯВАМ СЕ**].  

![](901-installing2.png){ class=align-center w=15cm }

Автоматично се отваря форма за указване място за запис на изпълнимия файл **DreemPrs20.exe**.  

Файлът се стартира  и инсталацията се потвърждава с бутон [**Yes**].  
