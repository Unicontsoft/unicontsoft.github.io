...
Сторно операциите отразяват възстановяването на суми по платени документи. Сумата се намалява от касовата наличност и се връща на клиент.  

> За всяка операция се издава сторно касов бон.  

Сторно може да бъде направено към:  
- Документ за продажба - Сторнира се единствено свързаното плащане към приключена продажба.  
- Кредитен документ - В този случай се създава кредитен документ за корекции по продажба, като се сторнира и плащането към нея.  
